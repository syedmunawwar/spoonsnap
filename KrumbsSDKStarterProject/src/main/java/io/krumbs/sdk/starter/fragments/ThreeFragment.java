...
public class    ThreeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vview=inflater.inflate(R.layout.fragment_three, container, false);
        recyclerView = (RecyclerView) vview.findViewById(R.id.my_recycler_view);
        last_five_text=(TextView) vview.findViewById(R.id.Last_five_text);
        getDayData();
        ...
        new AsyncTask<Void, Void, JSONArray>(){
           ...
           // DialogUtils dialogUtils = new DialogUtils(getActivity(),DialogUtils.Type.PROGRESS_DIALOG);
            ...
            protected JSONArray doInBackground(Void... params) {
                return new ServerRequest().loadFiveUpload(getContext(),getWeekData());
            }
            ...
            protected void onPostExecute(JSONArray response) {
              ...
              //  dialogUtils.dismissProgressDialog();
                if (response != null) {
                    ...
                    last_five_text.setText("You Have Not Uploaded any Reports Till Now");
